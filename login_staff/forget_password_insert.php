<?php
    ...
    if($getresult)
    {
        ...
        $update = mysqli_query($conn,"UPDATE staffaccount SET Token = '$Token' WHERE Email = '$Email'");

        /* Link to Reset Password */

        $link = "<a href='http://localhost/ATPCBank_1044/login_staff/reset_password.php?key=".$Email."&token=".$Token."'>CLICK TO RESET PASSWORD</a>";
